...
The NKI team mentioned to us that BAS1 BAS2 BAS3 are inconsequential differentiators.
Instead, everyone with a BAS is considered a BASELINE visit. Individuals who return then
get a FLU1 (follow up) visit. Those who return multiple times then get a TRT (treatment) visit, but we do not need to differentiate these -- they are just called FLU 1 and 2. 
